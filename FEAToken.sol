...
// File: contracts/FEAToken.sol

contract FEAToken is StandardToken, BurnableToken, NoOwner {
  string public constant name = "First Evangelist Action Token"; // solium-disable-line uppercase
  string public constant symbol = "FEAT"; // solium-disable-line uppercase
