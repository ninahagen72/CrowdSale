...
// File: contracts/FEACrowdsale.sol

contract FEACrowdsale is
  Crowdsale,
  TimedCrowdsale,
  ...
  Whitelist
{
  ...
  uint256 private phaseOneTokens = 15000000 * 10**18; // tokens available in phase one

  uint256 private phaseTwoTokens = 50000000 * 10**18; // tokens available in phase two
